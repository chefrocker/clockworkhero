...
export const SessionModal: React.FC<Props> = ({ isOpen, onClose, onSave, onDelete, onAddProject, start, end, projects, editingSessionId, initialData }) => {
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{ width: '700px' }}>
        ...
        <div className="modal-body">
          <div style={{
            ...
            <div className="input-group">
              <label htmlFor="session-duration" className="input-label">Dauer (Min)</label>
              <input
                id="session-duration"
          ...
          <div className="input-group" style={{ marginBottom: '20px' }}>
            ...
            {!isCreatingProject ? (
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <input
                  id="new-project-quick-name"
                  name="new-project-quick-name"
          ...
          <div className="input-group">
            <label htmlFor="session-description" className="input-label">Beschreibung</label>
            <textarea
